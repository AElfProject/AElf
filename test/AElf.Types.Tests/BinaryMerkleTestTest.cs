    ...
    public class BinaryMerkleTestTest
    {
        ...
        public void TestMerklePathFromEth()
        {
                        ...
                        "0x90ae927b3312b71e5ea7c8644a9d6f4e6107bf6c0e06df094c94be16d8023c52"));
            {
                ...
                var actualHash = Hash.FromRawBytes(ByteArrayHelper.HexStringToByteArray(hex));
        ...
        {
            var hashFromString = Hash.FromString(address);
            ...
            var hashFromAmount = Hash.FromRawBytes(amountBytes.ToArray());
