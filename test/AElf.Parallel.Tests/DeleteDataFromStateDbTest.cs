...
public sealed class DeleteDataFromStateDbTest : AElfIntegratedTest<ParallelTestWithoutFeeAElfModule>
{
    ...
    public async Task Set_Value()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ...
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub.IncreaseValue),
            increaseValueInput);
    ...
    public async Task Set_Value_With_Inline()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ...
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueWithInline), increaseValueInput);
        transactions.Add(transaction);

        transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueWithInline), otherKeyInput);
        transactions.Add(transaction);
    ...
    public async Task Set_Value_With_PrePlugin()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueWithPrePlugin), increaseValueInput);
        transactions.Add(transaction);

        transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueWithPrePlugin), otherKeyInput);
        transactions.Add(transaction);
    ...
    public async Task Set_Value_With_PostPlugin()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueWithPostPlugin), increaseValueInput);
        transactions.Add(transaction);

        transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueWithPostPlugin), otherKeyInput);
        transactions.Add(transaction);
    ...
    public async Task Set_Value_With_Inline_And_PrePlugin()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueWithInlineAndPrePlugin), increaseValueInput);
        transactions.Add(transaction);

        transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueWithInlineAndPrePlugin), otherKeyInput);
        transactions.Add(transaction);
    ...
    public async Task Set_Value_With_Inline_And_PostPlugin()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueWithInlineAndPostPlugin), increaseValueInput);
        transactions.Add(transaction);

        transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueWithInlineAndPostPlugin), otherKeyInput);
        transactions.Add(transaction);
    ...
    public async Task Set_Value_With_Plugin()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueWithPlugin), increaseValueInput);
        transactions.Add(transaction);

        transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueWithPlugin), otherKeyInput);
        transactions.Add(transaction);
    ...
    public async Task Set_Value_With_Inline_And_Plugin()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueWithInlineAndPlugin), increaseValueInput);
        transactions.Add(transaction);

        transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueWithInlineAndPlugin), otherKeyInput);
        transactions.Add(transaction);
    ...
    public async Task Set_Value_Parallel_With_Inline_And_Plugin()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueParallelWithInlineAndPlugin), increaseValueInput);
        transactions.Add(transaction);

        transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueParallelWithInlineAndPlugin), otherKeyInput);
        transactions.Add(transaction);
    ...
    public async Task Remove_Not_Exist_Key()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub.RemoveValue),
            new RemoveValueInput
            {
                Key = key
            });
    ...
    public async Task Remove_After_Set_Key()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .RemoveAfterSetValue), new RemoveAfterSetValueInput
            {
                Key = key,
                Int64Value = 10,
                StringValue = "test",
    ...
    public async Task Set_After_Remove_Key()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub.SetValue),
            setValueInput);
        var transactions = new List<Transaction> { transaction };
        var block = _parallelTestHelper.GenerateBlock(chain.BestChainHash, chain.BestChainHeight, transactions);
        block = (await _blockExecutingService.ExecuteBlockAsync(block.Header, transactions)).Block;
        ...
        transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .SetAfterRemoveValue), setAfterRemoveValueInput);
    ...
    public async Task Complex_ChangeAndDelete_Key()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .ComplexChangeWithDeleteValue1), complexChangeInput);
        var transactions = new List<Transaction> { transaction };
        var block = _parallelTestHelper.GenerateBlock(chain.BestChainHash, chain.BestChainHeight, transactions);
        block = (await _blockExecutingService.ExecuteBlockAsync(block.Header, transactions)).Block;
        await _blockchainService.AddTransactionsAsync(transactions);
        ...
        transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .ComplexChangeWithDeleteValue2), complexChangeInput);
        transactions = new List<Transaction> { transaction };
        ...
        transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .ComplexChangeWithDeleteValue3), complexChangeInput);
        transactions = new List<Transaction> { transaction };
        block = _parallelTestHelper.GenerateBlock(chain.BestChainHash, chain.BestChainHeight, transactions);
        block = (await _blockExecutingService.ExecuteBlockAsync(block.Header, transactions)).Block;
        await _blockchainService.AddTransactionsAsync(transactions);
    ...
    public async Task Remove_Value_From_PrePlugin()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .RemoveValueFromPrePlugin), new RemoveValueInput
            {
                Key = key
            });
        var transactions = new List<Transaction> { transaction };
    ...
    public async Task Remove_Value_With_Plugin()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .RemoveValueWithPlugin), new RemoveValueInput
            {
                Key = key
            });
        transactions.Add(transaction);
    ...
    public async Task Remove_Value_From_Inline_With_Plugin()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .RemoveValueFromInlineWithPlugin), new RemoveValueInput
            {
                Key = key
            });
        var transactions = new List<Transaction> { transaction };
    ...
    public async Task Remove_Value_From_PostPlugin()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .RemoveValueFromPostPlugin), new RemoveValueInput
            {
                Key = key
            });
        var transactions = new List<Transaction> { transaction };
    ...
    public async Task Remove_Value_In_Blocks()
    {
        ...
        var keys = new[]
            { "TestKeyOne", "TestKeyTwo", "TestKeyThree", "TestKeyFour", "TestKeyFive", "TestKeySix", "TestKeySeven" };
        ...
        var tasks = keys.Select(key => GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueWithInlineAndPlugin), new IncreaseValueInput
            {
                Key = key,
                Memo = Guid.NewGuid().ToString()
            }));
        ...
        //First Block
        {
            ...
            //System Transaction
            {
                ...
                transaction = await GenerateTransactionAsync(accountAddress,
                    ParallelTestHelper.BasicFunctionWithParallelContractAddress,
                    nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                        .RemoveValueFromPostPlugin), removeValueInput);
                systemTransactions.Add(transaction);
                ...
                transaction = await GenerateTransactionAsync(accountAddress,
                    ParallelTestHelper.BasicFunctionWithParallelContractAddress,
                    nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                        .RemoveValueParallelFromPostPlugin), removeValueInput);
                systemTransactions.Add(transaction);
    ...
    public async Task Increase_Value_Failed()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueFailed), new IncreaseValueInput
            {
                Key = key,
                Memo = Guid.NewGuid().ToString()
            });
    ...
    public async Task Increase_Value_Parallel_Failed()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueParallelFailed), new IncreaseValueInput
            {
                Key = key,
                Memo = Guid.NewGuid().ToString()
            });
    ...
    public async Task Increase_Value_Failed_With_PrePlugin()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueFailedWithPrePlugin), new IncreaseValueInput
            {
                Key = key,
                Memo = Guid.NewGuid().ToString()
            });
    ...
    public async Task Increase_Value_Failed_With_PostPlugin()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueFailedWithPostPlugin), new IncreaseValueInput
            {
                Key = key,
                Memo = Guid.NewGuid().ToString()
            });
    ...
    public async Task Increase_Value_Failed_With_Inline_And_PrePlugin()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueFailedWithInlineAndPrePlugin), new IncreaseValueInput
            {
                Key = key,
                Memo = Guid.NewGuid().ToString()
            });
    ...
    public async Task Increase_Value_Failed_With_Plugin()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueFailedWithPlugin), new IncreaseValueInput
            {
                Key = key,
                Memo = Guid.NewGuid().ToString()
            });
    ...
    public async Task Increase_Value_Failed_With_Inline_And_Plugin()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueFailedWithInlineAndPlugin), new IncreaseValueInput
            {
                Key = key,
                Memo = Guid.NewGuid().ToString()
            });
    ...
    public async Task Increase_Value_Failed_Parallel_With_Inline_And_Plugin()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueFailedParallelWithInlineAndPlugin), new IncreaseValueInput
            {
                Key = key,
                Memo = Guid.NewGuid().ToString()
            });
    ...
    public async Task Increase_Value_With_Failed_Inline_And_PrePlugin()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueWithFailedInlineAndPrePlugin), new IncreaseValueInput
            {
                Key = key,
                Memo = Guid.NewGuid().ToString()
            });
    ...
    public async Task Increase_Value_With_Failed_Inline_And_PostPlugin()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueWithFailedInlineAndPostPlugin), new IncreaseValueInput
            {
                Key = key,
                Memo = Guid.NewGuid().ToString()
            });
    ...
    public async Task Increase_Value_With_Failed_Inline_And_Plugin()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueWithFailedInlineAndPlugin), new IncreaseValueInput
            {
                Key = key,
                Memo = Guid.NewGuid().ToString()
            });
    ...
    public async Task Increase_Value_Parallel_With_Failed_Inline_And_Plugin()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueParallelWithFailedInlineAndPlugin), new IncreaseValueInput
            {
                Key = key,
                Memo = Guid.NewGuid().ToString()
            });
    ...
    public async Task Increase_Value_Failed_With_Inline_And_PostPlugin()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueFailedWithInlineAndPostPlugin), new IncreaseValueInput
            {
                Key = key,
                Memo = Guid.NewGuid().ToString()
            });
    ...
    public async Task Increase_Value_With_Failed_PrePlugin()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueWithFailedPrePlugin), new IncreaseValueInput
            {
                Key = key,
                Memo = Guid.NewGuid().ToString()
            });
    ...
    public async Task Increase_Value_With_Inline_And_Failed_PrePlugin()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueWithInlineAndFailedPrePlugin), new IncreaseValueInput
            {
                Key = key,
                Memo = Guid.NewGuid().ToString()
            });
    ...
    public async Task Increase_Value_With_Failed_PrePlugin_And_PostPlugin()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueWithFailedPrePluginAndPostPlugin), new IncreaseValueInput
            {
                Key = key,
                Memo = Guid.NewGuid().ToString()
            });
    ...
    public async Task Increase_Value_With_Inline_And_Failed_PrePlugin_And_PostPlugin()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueWithInlineAndFailedPrePluginAndPostPlugin), new IncreaseValueInput
            {
                Key = key,
                Memo = Guid.NewGuid().ToString()
            });
    ...
    public async Task Increase_Value_With_Failed_PostPlugin()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueWithFailedPostPlugin), new IncreaseValueInput
            {
                Key = key,
                Memo = Guid.NewGuid().ToString()
            });
    ...
    public async Task Increase_Value_With_Inline_And_Failed_PostPlugin()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueWithInlineAndFailedPostPlugin), new IncreaseValueInput
            {
                Key = key,
                Memo = Guid.NewGuid().ToString()
            });
    ...
    public async Task Increase_Value_With_PrePlugin_And_Failed_PostPlugin()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueWithPrePluginAndFailedPostPlugin), new IncreaseValueInput
            {
                Key = key,
                Memo = Guid.NewGuid().ToString()
            });
    ...
    public async Task Increase_Value_With_Inline_And_PrePlugin_And_Failed_PostPlugin()
    {
        ...
        var transaction = await GenerateTransactionAsync(accountAddress,
            ParallelTestHelper.BasicFunctionWithParallelContractAddress,
            nameof(BasicFunctionWithParallelContractContainer.BasicFunctionWithParallelContractStub
                .IncreaseValueWithInlineAndPrePluginAndFailedPostPlugin), new IncreaseValueInput
            {
                Key = key,
                Memo = Guid.NewGuid().ToString()
            });
    ...
    private async Task<Transaction> GenerateTransactionAsync(Address from, Address to, string methodName,
        IMessage input)
    {
    ...
    private async Task CheckValueInVersionStateAsync(string key, long longValue, string stringValue,
        MessageValue messageValue)
    {
        var state = await _versionedStates.GetAsync(new ScopedStatePath
        {
