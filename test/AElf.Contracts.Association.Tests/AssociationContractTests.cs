...
namespace AElf.Contracts.Association
{
    public class AssociationContractTests : AssociationContractTestBase<AssociationContractTestAElfModule>
    {
        ...
        public async Task Get_Proposal_Test()
        {
            //failed case
            {
                var proposal = await AssociationContractStub.GetProposal.CallAsync(Hash.ComputeFrom("Test"));
        ...
        {
            var transactionResult =
                await AssociationContractStub.Approve.SendWithExceptionAsync(Hash.ComputeFrom("Test"));
            transactionResult.TransactionResult.Status.ShouldBe(TransactionResultStatus.Failed);
        }
        ...
        public async Task Release_Proposal_Failed_Test()
        {
            //not found
            {
                var fakeId = Hash.ComputeFrom("test");
