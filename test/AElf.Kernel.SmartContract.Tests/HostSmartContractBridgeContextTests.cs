...
public class HostSmartContractBridgeContextTests : SmartContractRunnerTestBase
{
    ...
    [Fact]
    public void ParseJsonToPlainDictionary_test_1layer()
    {
        var hostSmartContractBridgeContext = CreateNewContext();
        
        string jsonText = "{\"number\": 709, \"message\": \"My message here\",\"bool\": true}";

        var output = hostSmartContractBridgeContext.ParseJsonToPlainDictionary(jsonText);
        
        output.Keys.ShouldContain("number");
        output["number"].ShouldBe("709");
        output.Keys.ShouldContain("message");
        output["message"].ShouldBe("My message here");
        output.Keys.ShouldContain("bool");
        output["bool"].ShouldBe("True");
    }
    
    [Fact]
    public void ParseJsonToPlainDictionary_test_2layer()
    {
        var hostSmartContractBridgeContext = CreateNewContext();
        string jsonText = "{\"number\": 709, \"message\": \"My message here\",\"bool\": true}";
        string jsonText2 = "{\"number\": 709, \"myobject\": " + jsonText + ", \"message\": \"My message here\",\"bool\": true}";

        var output = hostSmartContractBridgeContext.ParseJsonToPlainDictionary(jsonText2);
        ...
        output = hostSmartContractBridgeContext.ParseJsonToPlainDictionary((string)output["myobject"]);
    ...
    [Fact]
    public void ParseJsonToPlainDictionary_test_2layer_array()
    {
        var hostSmartContractBridgeContext = CreateNewContext();
        
        string jsonText = "{\"number\": 709, \"message\": \"My message here\",\"bool\": true}";
        string jsonText2 = "{\"number\": 709, \"myarray\": [" + jsonText + ", " + jsonText + "], \"message\": \"My message here\",\"bool\": true}";
        ...
        List<string> list = (List<string>)output["myarray"];

        output = hostSmartContractBridgeContext.ParseJsonToPlainDictionary(list[0]);
