...
namespace AElf.Kernel.SmartContract.Application
{
    public class SmartContractServiceTests : SmartContractRunnerTestBase
    {
        ...
        public async Task Deploy_Contract_Success()
        {
            ...
            await _smartContractService.DeployContractAsync(SampleAddress.AddressList[7], registration, false, null);
        ...
        public async Task Update_Contract_Success()
        {
            ...
            await _smartContractService.DeployContractAsync(SampleAddress.AddressList[1], registrationA, false, null);
            await _smartContractService.UpdateContractAsync(SampleAddress.AddressList[2], registrationANew, false, null);


            await _smartContractService.UpdateContractAsync(SampleAddress.AddressList[3], registrationB, false, null);
