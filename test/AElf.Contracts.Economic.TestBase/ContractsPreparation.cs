...
namespace AElf.Contracts.Economic.TestBase
{
    ...
    public partial class EconomicContractsTestBase
    {
        ...
        protected void DeployAllContracts()
        {
            ...
            var methodCallThresholdContractCode = Codes.Single(kv => kv.Key.Contains("MethodCallThreshold")).Value;
            AsyncHelper.RunSync(()=>SetContractCacheAsync(MethodCallThresholdContractAddress, Hash.FromRawBytes(methodCallThresholdContractCode)));
