...
namespace AElf.Kernel.Blockchain.Application
{
    public class FullBlockchainServiceTests : AElfKernelWithChainTestBase
    {
        ...
        {
            var result = await _fullBlockchainService.HasBlockAsync(Hash.ComputeFrom("Not Exist Block"));
        ...
        public async Task Get_GetReservedBlockHashes_ReturnNull()
        {
            ...
            var result = await _fullBlockchainService.GetReversedBlockIndexes(Hash.ComputeFrom("not exist"), 1);
        ...
        {
            var result = await _fullBlockchainService.GetBlocksInBestChainBranchAsync(Hash.ComputeFrom("not exist"), 3);
            result.Count.ShouldBe(0);
        }
        ...
        {
            var chain = await _fullBlockchainService.GetChainAsync();
            var notExistHash = Hash.ComputeFrom("not exist");
        ...
        {
            var result = await _fullBlockchainService.GetBlockByHashAsync(Hash.ComputeFrom("Not Exist Block"));
            result.ShouldBeNull();
        }
        ...
        public async Task Get_BestChain_ReturnBlockHeader()
        {
            ...
            var newBlock = _kernelTestHelper.GenerateBlock(chain.BestChainHeight, Hash.ComputeFrom("New Branch"));
        ...
        public async Task Get_DiscardedBranch_Test()
        {
...

            {
                ...
                discardedBranch.NotLinkedKeys.ShouldContain(_kernelTestHelper.UnlinkedBranchBlockList[0].Header
...

            {
                ...
                discardedBranch.NotLinkedKeys.ShouldContain(_kernelTestHelper.UnlinkedBranchBlockList[0].Header
                    .PreviousBlockHash.ToStorageKey());
                discardedBranch.NotLinkedKeys.ShouldContain(_kernelTestHelper.UnlinkedBranchBlockList[1].Header
                    .PreviousBlockHash.ToStorageKey());
            }
        }
        ...
        public async Task Clean_ChainBranch_Test()
        {
            ...
            var discardedBranch = new DiscardedBranch
            {
                ...
                {
                    _kernelTestHelper.UnlinkedBranchBlockList[0].Header.PreviousBlockHash.ToStorageKey(),
                    _kernelTestHelper.UnlinkedBranchBlockList[1].Header.PreviousBlockHash.ToStorageKey(),
                    "Not Exist Block"
                }
            };
