...
namespace AElf.Contracts.EconomicSystem
{
    public class EconomicSystemTestBase : ContractTestBase<EconomicSystemTestModule>
    {
        ...
        internal AElfConsensusContractContainer.AElfConsensusContractStub GetAElfConsensusContractStub(
            ECKeyPair keyPair)
        {
            return GetTester<AElfConsensusContractContainer.AElfConsensusContractStub>(ConsensusContractAddress,
                keyPair);
        }
        ...
        private SystemContractDeploymentInput.Types.SystemTransactionMethodCallList GenerateTokenInitializationCallList()
        {
            ...
            tokenContractCallList.Add(nameof(TokenContract.CreateNativeToken), new CreateNativeTokenInput
            {
                ...
                IsBurnable = true,
                TokenName = "elf token",
                TotalSupply = EconomicSystemTestConstants.NativeTokenTotalSupply,
            ...
            {
                Symbol = "ELF",
                Amount = EconomicSystemTestConstants.NativeTokenTotalSupply / 5,
