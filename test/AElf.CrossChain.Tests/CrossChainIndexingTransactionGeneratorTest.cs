...
namespace AElf.CrossChain
{
    public sealed class CrossChainIndexingTransactionGeneratorTest : CrossChainWithChainTestBase
    {
        ...
        public async Task GenerateTransactions_Test()
        {
            ...
            _crossChainIndexingTransactionGenerator.GenerateTransactions(AddressHelper.StringToAddress("from"),0,Hash.Empty, ref transactions);
            ...
            var smartContractAddress = AddressHelper.StringToAddress("CrossChainContract");
            ...
            _crossChainIndexingTransactionGenerator.GenerateTransactions(AddressHelper.StringToAddress("from"),previousBlockHeight,previousBlockHash, ref transactions);
            
            transactions.Count.ShouldBe(1);
            transactions[0].From.ShouldBe(AddressHelper.StringToAddress("from"));
