...
namespace AElf.Contracts.Consensus.AEDPoS
{
    public partial class AEDPoSTest
    {
        ...
        public async Task EvilNodeDetectionTest()
        {
            ...
            var randomHashes = Enumerable.Range(0, AEDPoSContractTestConstants.InitialMinersCount).Select(_ => HashHelper.Generate()).ToList();
            ...
            var randomHash = HashHelper.Generate();
            ...
            var cheatInformationBytes = await oneCandidate.GetInformationToUpdateConsensus.CallAsync(
                new AElfConsensusTriggerInformation
                {
                    ...
                    RandomHash = HashHelper.Generate(), // Don't care this value in current test case.
                    Pubkey = ByteString.CopyFrom(CandidatesKeyPairs[0].PublicKey)
                }.ToBytesValue());
