...
namespace AElf.Contracts.TestBase
{
        ...
        where TContractTestAElfModule : ContractTestAElfModule
    {
        ...
        public async Task<OsBlockchainNodeContext> InitialChainAsync(Action<List<GenesisSmartContractDto>> configureSmartContract = null)
        {
            ...
            var dposOptions = Application.ServiceProvider.GetService<IOptionsSnapshot<ConsensusOptions>>().Value;
        ...
        private SystemContractDeploymentInput.Types.SystemTransactionMethodCallList GenerateConsensusInitializationCallList(ConsensusOptions dposOptions)
        {
