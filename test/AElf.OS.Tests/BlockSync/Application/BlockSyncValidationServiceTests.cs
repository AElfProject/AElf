...
namespace AElf.OS.BlockSync.Application
{
    public class BlockSyncValidationServiceTests : BlockSyncTestBase
    {
        ...
        public async Task ValidateAnnouncement_Success()
        {
            ...
            {
                BlockHash = Hash.ComputeFrom("SyncBlockHash"),
        ...
        public async Task ValidateBlock_LessThenLIBHeight()
        {
            ...
            var block = _osTestHelper.GenerateBlockWithTransactions(Hash.ComputeFrom("SyncBlockHash"),
        ...
        public void TryAddAnnouncementCache_MultipleTimes()
        {
            for (var i = 0; i < 120; i++)
            {
                var blockHash = Hash.ComputeFrom(Guid.NewGuid().ToString());
                var blockHeight = i;
