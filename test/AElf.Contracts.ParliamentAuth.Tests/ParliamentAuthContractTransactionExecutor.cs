...
{
    public class ParliamentAuthContractTransactionExecutor: ITransactionExecutor
    {
        private readonly IServiceProvider _serviceProvider;

        public ParliamentAuthContractTransactionExecutor(IServiceProvider serviceProvider)
        {
