...
namespace AElf.Types.Tests.Helpers
{
    public class ByteStringHelpersTests
    {
        ...
        public void ByteString_Compare()
        {
            ...
            var byteString2 = ByteString.CopyFrom(new byte[2] { 04, 10 });
            var byteString3 = ByteString.CopyFrom(new byte[3] { 00, 12, 14 });
            var byteString4 = ByteString.CopyFrom(new byte[3] { 10, 12, 14 });
            var byteString5 = ByteString.CopyFrom(new byte[1] { 02 });
            ...
            ByteStringHelpers.Compare(byteString2, byteString5).ShouldBe(1);
        }
