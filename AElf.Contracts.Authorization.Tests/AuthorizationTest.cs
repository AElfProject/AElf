    ...
    public class AuthorizationTest
    {
        ...
        public void ProposeInvalidProposal()
        {
            ...
            var validProposal = new Proposal
            {
                ...
                Proposer = Address.FromPublicKey(ChainId, kp1.PublicKey),
        ...
        public void SayYes()
        {
            ...
            var sayYesRes = _contract.SayYes(notAuthorizedApproval, Address.FromPublicKey(ChainId, newKp.PublicKey)).Result;
            ...
            sayYesRes = _contract.SayYes(validApproval, Address.FromPublicKey(ChainId, kp1.PublicKey)).Result;
        ...
        public void Release()
        {
            ...
            var res1 = _contract.SayYes(validApproval1, Address.FromPublicKey(ChainId, kp1.PublicKey)).Result;
            Assert.True(res1);
            ...
            var res2 = _contract.SayYes(validApproval2, Address.FromPublicKey(ChainId, kp3.PublicKey)).Result;
            Assert.True(res2);
            ...
            var res3 = _contract.SayYes(validApproval3, Address.FromPublicKey(ChainId, kp2.PublicKey)).Result;
            Assert.True(res3);
