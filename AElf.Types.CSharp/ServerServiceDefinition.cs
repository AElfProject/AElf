...
namespace AElf.Types.CSharp
{
    ...
    public class ServerServiceDefinition
    {
        ...
        public class Builder
        {
            ...
            private readonly List<Action<ServiceBinderBase>> addMethodActions = new List<Action<ServiceBinderBase>>();

            // to maintain legacy behavior, we need to detect duplicate keys and throw the same exception as before
            private readonly Dictionary<string, object> duplicateDetector = new Dictionary<string, object>();
