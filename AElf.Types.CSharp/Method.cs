...
namespace AElf.Types.CSharp
{
    ...
    public class Method<TRequest, TResponse> : IMethod
    {
        ...
        {
            Type = type;
            ServiceName = Preconditions.CheckNotNull(serviceName, "serviceName");
            Name = Preconditions.CheckNotNull(name, "name");
            RequestMarshaller = Preconditions.CheckNotNull(requestMarshaller, "requestMarshaller");
            ResponseMarshaller = Preconditions.CheckNotNull(responseMarshaller, "responseMarshaller");
