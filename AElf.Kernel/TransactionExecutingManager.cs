...
namespace AElf.Kernel
{
    public class TransactionExecutingManager : ITransactionExecutingManager
    {
        ...
        private readonly IChainContextFactory _chainContextFactory;

        public TransactionExecutingManager(ISmartContractManager smartContractManager, IChainContextFactory chainContextFactory)
        {
        ...
        private void ColorGraph(List<ITransaction> transactions, IChain chain)
        {
            ...
            var chainContext = _chainContextFactory.GetChainContext(chain.Id);
            // coloring whol graph
