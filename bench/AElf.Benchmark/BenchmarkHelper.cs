...
namespace AElf.Benchmark
{
    public class BenchmarkHelper
    {
        ...
        public IReadOnlyDictionary<string, byte[]> Codes =>
            _codes ?? (_codes = ContractsDeployer.GetContractCodes<BenchmarkHelper>());
        ...
        public BenchmarkHelper(IOsBlockchainNodeContextService osBlockchainNodeContextService,
        ...
        private async Task<List<Block>> AddBestBranch()
        {
            ...
            for (var i = 0; i < 10; i++)
            {
                ...
                MockChainTokenAmount += TransferInput.Parser.ParseFrom(transaction.Params).Amount;
