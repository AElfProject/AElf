...
using AElfDPoS = AElf.Contracts.DPoS.ConsensusContract.AElfDPoS;
using AElfDPoSFiledMapCollection = AElf.Contracts.DPoS.ConsensusContract.FieldMapCollections.AElfDPoSFiledMapCollection;
