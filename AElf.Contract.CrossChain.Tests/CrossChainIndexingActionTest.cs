...
namespace AElf.Contract.CrossChain.Tests
{
    public class CrossChainIndexingActionTest : CrossChainContractTestBase
    {
        ...
        public async Task RecordParentChainData_Twice()
        {
            ...
            var tx = await GenerateTransaction(CrossChainContractAddress, CrossChainConsts.CrossChainIndexingMethodName, null,
                crossChainBlockData);
        ...
        public async Task RecordSideChainData()
        {
            ...
            var indexingTx = await GenerateTransaction(CrossChainContractAddress,
        ...
        public async Task RecordSideChainData_WithChainNotExist()
        {
            ...
            var tx2 = await GenerateTransaction(CrossChainContractAddress, "CreateSideChain", null, sideChainId2);
