            ...
            new EventLoopScheduler().Schedule(() =>
            {
                ...
                (
                    async x =>
                    {
                        ...
                        var blockHash = await blockchain.GetCurrentBlockHashAsync();
                        var currentHeightOfThisNode = (long)((BlockHeader)await blockchain.GetHeaderByHashAsync(blockHash)).Index;
