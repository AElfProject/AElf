            ...
            NoRestore = true,
                ...
                ArgumentCustomization = args => {
                    return args.Append("/p:CollectCoverage=true")
                        ...
                        .Append("/p:Exclude=[coverlet.*.tests?]*%2c[xunit.*]*%2c[AElf.Kernel.Consensus.Scheduler.*]*%2c[AElf.Database]AElf.Database.RedisProtocol.*%2c[AElf.Test.Helpers]*%2c[*]*Exception*%2c[AElf.Contracts.GenesisUpdate]*")
