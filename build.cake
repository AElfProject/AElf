    ...
    var testSetting = new DotNetCoreTestSettings{
        ...
        ArgumentCustomization = args => {
            return args.Append("/p:CollectCoverage=true")
                       ...
                       .Append("/p:ExcludeByFile=**/test/**%2c../../src/AElf.Runtime.CSharp.Core/Metadata/*.cs%2c../../src/AElf.Kernel.SmartContract/Metadata/*.cs%2c../../src/AElf.Database/RedisDatabase.cs%2c../*.TestBase/*.cs");}                   
};
