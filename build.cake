    ...
    var testSetting = new DotNetCoreTestSettings{
        ...
        ArgumentCustomization = args => {
            return args.Append("--logger trx")
                       ...
                       .Append("/p:Exclude=[coverlet.*.tests?]*%2c[xunit.*]*%2c[AElf.Kernel.Consensus.Scheduler.*]*%2c[AElf.Database]AElf.Database.RedisProtocol.*%2c[AElf.Test.Helpers]*%2c[*BouncyCastle*]*%2c[*]*Exception%2c[*.Tests]*%2c[AElf.Contracts.GenesisUpdate]*%2c[AElf.WebApp.Application.Chain]*%2c[AElf.WebApp.Application.Net]*")
