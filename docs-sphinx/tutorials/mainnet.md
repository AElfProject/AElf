...
>> cd /tmp/ && wget https://github.com/AElfProject/AElf/releases/download/v1.4.0/aelf-mainnet-mainchain.zip
...
>> docker pull aelf/node:mainnet-v1.4.0
>> cd /opt/aelf-node
>> sh aelf-node.sh start aelf/node:mainnet-v1.4.0
```
...
``` bash
>> cd /tmp/ && wget https://github.com/AElfProject/AElf/releases/download/v1.4.0/aelf.zip
>> unzip aelf.zip
...
v1.4.0), and secondly make sure to compile on a Ubuntu Linux
...
``` bash
>> cd /tmp/ && wget https://github.com/AElfProject/AElf/releases/download/v1.4.0/aelf-mainnet-sidechain1.zip
...
run script) for the side-chain:
    ...
    wget https://github.com/AElfProject/AElf/releases/download/v1.4.0/aelf-mainnet-sidechain1.zip
