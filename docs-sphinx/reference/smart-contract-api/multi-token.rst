...
| Field               | Type                              | Description                       | Label   |
+=====================+===================================+===================================+=========+
| delegator_address   | `aelf.Address <#aelf.Address>`__  | The address of delegator.         |         |
+---------------------+-----------------------------------+-----------------------------------+---------+

.. raw:: html

   <div id="token.GetTransactionFeeDelegateesOutput">

.. raw:: html

   </div>

token.GetTransactionFeeDelegateesOutput
'''''''''''''''''''''''''''''''''''''''''

+---------------------+-----------------------------------+-----------------------------------+---------+
| Field               | Type                              | Description                       | Label   |
+=====================+===================================+===================================+=========+
| delegatee_address   | `aelf.Address <#aelf.Address>`__  | The address of delegatee.         |         |
+---------------------+-----------------------------------+-----------------------------------+---------+
