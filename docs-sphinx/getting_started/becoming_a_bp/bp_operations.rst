...
You can enter the `Governance page <https://explorer.aelf.io/vote/election>`_, click the "Become a candidate node" button, and stake 100,000 ELF to join the node election.
...
If you want to try setting up a node and running as a BP in your local environment, please follow the `instructions <https://docs.aelf.io/en/latest/getting_started/becoming_a_bp/simulation_in_the_local_environment.html>`_ to simulate it in the local.