...
namespace AElf.Runtime.CSharp.Tests
{
    public class MockSetup
    {
        ...
        private async Task Init()
        {
            ...
            DataProvider1 = await (WorldStateDictator.SetChainId(ChainId1)).GetAccountDataProvider(PathContext.CalculatePointerForAccountZero(ChainId1));
            ...
            DataProvider2 = await (WorldStateDictator.SetChainId(ChainId2)).GetAccountDataProvider(PathContext.CalculatePointerForAccountZero(ChainId2));
        }
