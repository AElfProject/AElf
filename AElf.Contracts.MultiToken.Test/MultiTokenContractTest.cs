...
namespace AElf.Contracts.MultiToken
{
    public sealed class MultiTokenContractTest : ContractTestBase<MultiTokenContractTestAElfModule>
    {
        ...
        private Address BasicZeroContractAddress { get; }
        ...
        public async Task Approve_TokenContract()
        {
            ...
            var allowanceOutput = GetAllowanceOutput.Parser.ParseFrom(await Tester.CallContractMethodAsync(
        ...
        public async Task Initialize_TokenContract()
        {
            ...
            var result = GetBalanceOutput.Parser.ParseFrom(await Tester.CallContractMethodAsync(TokenContractAddress,
        ...
        public async Task Transfer_Without_Enough_Token()
        {
            ...
            var balance = GetBalanceOutput.Parser.ParseFrom(await from.CallContractMethodAsync(TokenContractAddress,
                nameof(TokenContract.GetBalance),
                new GetBalanceInput
                {
