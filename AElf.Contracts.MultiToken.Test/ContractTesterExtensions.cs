...
namespace AElf.Contracts.MultiToken
{
    public static class ContractTesterExtensions
    {
        ...
        public static async Task TransferTokenAsync(this ContractTester<MultiTokenContractTestAElfModule> starter,
            Address to,
            long amount)
        {
        ...
        public static async Task<TransactionResult> Lock(
            this ContractTester<MultiTokenContractTestAElfModule> contractTester, long amount,
            Hash lockId, Address lockToAddress = null)
        {
            if (lockToAddress == null) lockToAddress = contractTester.GetConsensusContractAddress();
        ...
        public static async Task<TransactionResult> Unlock(
            this ContractTester<MultiTokenContractTestAElfModule> contractTester, long amount,
            Hash lockId)
        {
            return await contractTester.ExecuteContractWithMiningAsync(contractTester.GetTokenContractAddress(),
