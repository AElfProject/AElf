...
namespace AElf.Kernel
{
    public class AElfKernelConventionalRegistrar : DefaultConventionalRegistrar
    {
        protected override ServiceLifetime? GetServiceLifetimeFromClassHierarcy(Type type)
        {
            ...
            if (type.Name.EndsWith("Factory")) return ServiceLifetime.Transient;
            if (type.Name.EndsWith("Store")) return ServiceLifetime.Transient;
            if (type.Name.EndsWith("Info")) return ServiceLifetime.Transient;
