...
namespace AElf.Kernel.SmartContract
{
    public interface IChainFunctionMetadata
    {
        ...
        ///     Throw when FunctionMetadataMap already contains a function with same
        ///     fullname
        /// </exception>
        /// <returns>
        ///     True when success, false when something is wrong (usually is cannot find record with respect to functionName
        ///     in the parameter otherFunctionsCallByThis)
        /// </returns>
