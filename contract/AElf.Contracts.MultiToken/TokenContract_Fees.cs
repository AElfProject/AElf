...
namespace AElf.Contracts.MultiToken
{
    ...
    {
        private IList<string> _symbolListToPayTxFee;
        private IList<string> _symbolListToPayRental;
        protected override void OnInitialized()
        {
            _symbolListToPayTxFee = Context.Variables.SymbolListToPayTxFee;
            _symbolListToPayRental = Context.Variables.SymbolListToPayRental;
        }
        /// <summary>
        ...
        {
            foreach (var symbol in _symbolListToPayTxFee)
            {
