...
public class AggregatorVerifierCoreStep3 : IAggregatorVerifierCoreStep
{
    public UInt256[] VerifyProof(UInt256[] transcript, UInt256[] aux, UInt256[] buf)
    {
        ...
        buf[16] = mulmod(buf[17], buf[35], AggregatorLib.QMod.DecToUInt256());
        AggregatorLib.EccMulAdd(buf, 12);
        (buf[14], buf[15]) = (transcript[38], transcript[39]);
        buf[16] = buf[17];
        AggregatorLib.EccMulAdd(buf, 12);
        (buf[14], buf[15]) = (buf[0], buf[1]);
        buf[16] = mulmod(buf[21], mulmod(buf[30], buf[7], AggregatorLib.QMod.DecToUInt256()), AggregatorLib.QMod.DecToUInt256());
        AggregatorLib.EccMulAdd(buf, 12);
        buf[17] = mulmod(mulmod(buf[19], buf[8], AggregatorLib.QMod.DecToUInt256()), buf[28], AggregatorLib.QMod.DecToUInt256());
        (buf[14], buf[15]) = (transcript[16], transcript[17]);
        buf[16] = mulmod(buf[17], buf[7], AggregatorLib.QMod.DecToUInt256());
        AggregatorLib.EccMulAdd(buf, 12);
        buf[20] = mulmod(buf[20], buf[23], AggregatorLib.QMod.DecToUInt256());
        (buf[14], buf[15]) = (transcript[18], transcript[19]);
        buf[16] = mulmod(buf[21], mulmod(buf[20], buf[7], AggregatorLib.QMod.DecToUInt256()), AggregatorLib.QMod.DecToUInt256());
        AggregatorLib.EccMulAdd(buf, 12);
        (buf[14], buf[15]) = (transcript[32], transcript[33]);
        buf[16] = mulmod(buf[25], buf[7], AggregatorLib.QMod.DecToUInt256());
        AggregatorLib.EccMulAdd(buf, 12);
        (buf[14], buf[15]) = (transcript[20], transcript[21]);
        buf[16] = buf[17];
        AggregatorLib.EccMulAdd(buf, 12);
        (buf[14], buf[15]) = (transcript[22], transcript[23]);
        buf[16] = mulmod(buf[21], buf[20], AggregatorLib.QMod.DecToUInt256());
        AggregatorLib.EccMulAdd(buf, 12);
        ...
        buf[16] = mulmod(buf[21], buf[26], AggregatorLib.QMod.DecToUInt256());
        AggregatorLib.EccMulAdd(buf, 12);
        buf[17] = mulmod(buf[24], buf[23], AggregatorLib.QMod.DecToUInt256());
        ...
        buf[16] = mulmod(buf[21], mulmod(buf[17], buf[7], AggregatorLib.QMod.DecToUInt256()), AggregatorLib.QMod.DecToUInt256());
        AggregatorLib.EccMulAdd(buf, 12);
        ...
        buf[16] = mulmod(buf[21], buf[17], AggregatorLib.QMod.DecToUInt256());
        AggregatorLib.EccMulAdd(buf, 12);
        ...
        buf[16] = mulmod(buf[21], mulmod(buf[24], buf[7], AggregatorLib.QMod.DecToUInt256()), AggregatorLib.QMod.DecToUInt256());
        AggregatorLib.EccMulAdd(buf, 12);
        ...
        buf[16] = mulmod(buf[21], buf[24], AggregatorLib.QMod.DecToUInt256());
        AggregatorLib.EccMulAdd(buf, 12);
        ...
        buf[16] = mulmod(buf[21], buf[31], AggregatorLib.QMod.DecToUInt256());
        AggregatorLib.EccMulAdd(buf, 12);
        ...
        buf[16] = mulmod(buf[21], buf[23], AggregatorLib.QMod.DecToUInt256());
        AggregatorLib.EccMulAdd(buf, 12);
        buf[17] = mulmod(buf[19], buf[19], AggregatorLib.QMod.DecToUInt256());
        (buf[14], buf[15]) = (transcript[24], transcript[25]);
        buf[16] = mulmod(buf[17], buf[23], AggregatorLib.QMod.DecToUInt256());
        AggregatorLib.EccMulAdd(buf, 12);
        ...
        buf[16] = mulmod(buf[25], buf[23], AggregatorLib.QMod.DecToUInt256());
        AggregatorLib.EccMulAdd(buf, 12);
