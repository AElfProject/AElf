...
namespace AElf.Contracts.Referendum
{
    public partial class ReferendumContract
    {
        ...
        private ReferendumReceiptCreated LockToken(string symbol, long amount, Hash proposalId, Address lockedAddress)
        {
            ...
            var lockId = HashHelper.ConcatAndCompute(HashHelper.ConcatAndCompute(HashHelper.ComputeFrom(proposalId), Context.TransactionId),
        ...
        {
            Hash proposalId = HashHelper.ConcatAndCompute(HashHelper.ConcatAndCompute(HashHelper.ComputeFrom(input), Context.TransactionId),
                HashHelper.ComputeFrom(Context.CurrentBlockTime.ToByteArray()));
