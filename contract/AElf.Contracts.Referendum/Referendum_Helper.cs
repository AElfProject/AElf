...
namespace AElf.Contracts.Referendum
{
    public partial class ReferendumContract
    {
        ...
        private ReferendumReceiptCreated LockToken(string symbol, long amount, Hash proposalId, Address lockedAddress)
        {
            ...
            var lockId = HashHelper.ConcatAndCompute(HashHelper.ConcatAndCompute(Hash.ComputeFrom(proposalId), Context.TransactionId),
                Hash.ComputeFrom(Context.CurrentBlockTime.ToByteArray()));
        ...
        {
            Hash proposalId = HashHelper.ConcatAndCompute(HashHelper.ConcatAndCompute(Hash.ComputeFrom(input), Context.TransactionId),
                Hash.ComputeFrom(Context.CurrentBlockTime.ToByteArray()));
        ...
        {
            var organizationHash = Hash.ComputeFrom(createOrganizationInput);
