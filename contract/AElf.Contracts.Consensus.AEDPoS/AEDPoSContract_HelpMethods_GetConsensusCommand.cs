...
namespace AElf.Contracts.Consensus.AEDPoS
{
    public partial class AEDPoSContract
    {
            ...
            while (true)
            {
                ...
                switch (behaviour)
                {
                    ...
                    case AElfConsensusBehaviour.TinyBlock:
                        ...
                        {
                            Context.LogDebug(() => "Next block mining left milliseconds is less than 0 for tiny block.");
        ...
        {
            if (currentRound.RoundNumber == 1 && currentRound.FirstMiner().OutValue == null)
            {
        ...
        /// 1. After publishing out value (producing normal block)
        /// 2. After generating information of next round (producing extra block)
        /// </summary>
        /// <param name="currentRound"></param>
        /// <param name="publicKey"></param>
            ...
            if (minerInRound.IsMinedBlockForCurrentRound())
            {
                ...
                expectedMiningTime = expectedMiningTime.AddMilliseconds(
                    currentRound.ExtraBlockProducerOfPreviousRound != publicKey
                        ...
                        : producedTinyBlocks.Sub(AEDPoSContractConstants.TinyBlocksNumber).Mul(timeForEachBlock));
            }
