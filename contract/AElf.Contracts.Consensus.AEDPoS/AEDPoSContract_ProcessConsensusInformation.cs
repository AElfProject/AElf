...
namespace AElf.Contracts.Consensus.AEDPoS
{
    ...
    public partial class AEDPoSContract
    {
        ...
        private void ProcessNextTerm(Round nextRound)
        {
            ...
            miners.Pubkeys.AddRange(nextRound.RealTimeMinersInformation.Keys.Select(k => k.FromHexString()));
        ...
        private void RecordMinedMinerListOfCurrentRound()
        {
            ...
            {
                Pubkeys = {currentRound.GetMinedMiners().Select(m => m.Pubkey.FromHexString())}
            });
        }
