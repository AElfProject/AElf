...
{
    public class InjectedSmartContractRunnerContainer : ISmartContractRunnerContainer
    {
        private readonly ConcurrentDictionary<int, ISmartContractRunner> _runners =
            new ConcurrentDictionary<int, ISmartContractRunner>();

        public InjectedSmartContractRunnerContainer(IEnumerable<ISmartContractRunner> runners)
        {
