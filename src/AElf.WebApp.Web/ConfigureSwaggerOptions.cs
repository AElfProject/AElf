        ...
        options.IncludeXmlComments(() =>
        {
            var webApiDocument =
                XDocument.Load(Path.Combine(
                    typeof(ChainApplicationWebAppAElfModule).Assembly.Location.Replace(".dll", ".xml")));
            webApiDocument.Root?.Add(XDocument
                .Load(
                    Path.Combine(typeof(NetApplicationWebAppAElfModule).Assembly.Location.Replace(".dll", ".xml")))
                .Root?.Elements());
