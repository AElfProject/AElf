...
internal partial class MethodFeeChargedPreExecutionPluginBase : SmartContractExecutionPluginBase, IPreExecutionPlugin,
    ISingletonDependency
{
    ...
    [ExceptionHandler(typeof(Exception), TargetType = typeof(MethodFeeChargedPreExecutionPluginBase),
        MethodName = nameof(HandleExceptionWhileGettingPreTransactions))]
