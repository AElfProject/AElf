...
namespace AElf.CrossChain
{
     ...
     public class CrossChainAElfModule : AElfModule
     {
         public override void ConfigureServices(ServiceConfigurationContext context)
         {
             ...
             context.Services.AddSingleton<IBasicCrossChainDataProvider, CrossChainDataProvider>();
             context.Services.AddSingleton<INewChainRegistrationService, CrossChainDataProvider>();
