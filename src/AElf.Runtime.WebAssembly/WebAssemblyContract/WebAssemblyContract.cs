...
public partial class WebAssemblyContract : CSharpSmartContract<WebAssemblyContractState>
{
    ...
    public WebAssemblyContract(byte[] wasmCode, bool withFuelConsumption = false, long memoryMin = 16,
        long memoryMax = 16)
    {
