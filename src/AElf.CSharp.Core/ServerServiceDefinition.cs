...
{
    private readonly IReadOnlyList<Action<ServiceBinderBase>> addDescriptorActions;
    ...
    internal ServerServiceDefinition(List<Action<ServiceBinderBase>> addMethodActions,
        List<Action<ServiceBinderBase>> addDescriptorActions)
    {
    ...
    {
        foreach (var addMethodAction in addMethodActions) addMethodAction(serviceBinder);

        foreach (var addDescriptorAction in addDescriptorActions) addDescriptorAction(serviceBinder);
    }
