...
{
    public class TransactionFeeExemptingService : ITransactionFeeExemptingService, ISingletonDependency
    {
        private readonly IEnumerable<IChargeFeeStrategy> _chargeFeeStrategies;

        public TransactionFeeExemptingService(IEnumerable<IChargeFeeStrategy> chargeFeeStrategies)
        {
