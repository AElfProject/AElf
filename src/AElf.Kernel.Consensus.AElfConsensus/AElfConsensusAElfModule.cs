...
namespace AElf.Kernel.Consensus.AElfConsensus
{
    ...
    public class AElfConsensusAElfModule : AElfModule
    {
        public override void ConfigureServices(ServiceConfigurationContext context)
        {

            context.Services.AddAssemblyOf<AElfConsensusAElfModule>();
            ...
            context.Services.AddSingleton<IAElfConsensusInformationProvider, AElfConsensusInformationProvider>();
