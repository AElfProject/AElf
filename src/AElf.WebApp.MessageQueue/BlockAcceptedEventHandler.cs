...
public class BlockAcceptedEventHandler : ILocalEventHandler<BlockAcceptedEvent>, ISingletonDependency
{
    ...
    public async Task HandleEventAsync(BlockAcceptedEvent eventData)
    {
        ...
        if (_blockExecutedSets.Count < _messageQueueOptions.PublishStep) return;
    ...
    private void UpdateResultList(TransactionResultListEto transactionResultListEto, Hash txId, IBlock block,
        Transaction tx,
