    ...
    public async Task<bool> ValidateTransactionAsync(Transaction transaction, IChainContext chainContext)
    {
        ...
        switch (transaction.MethodName)
        {
            case nameof(ACS0Container.ACS0Stub.DeployUserSmartContract):
                ...
                executionValidationResult = await _codeCheckService.PerformCodeCheckAsync(deployInput.Code.ToByteArray(), chainContext.BlockHash,
            ...
            case nameof(ACS0Container.ACS0Stub.UpdateUserSmartContract):
                ...
                {
                    executionValidationResult = await _codeCheckService.PerformCodeCheckAsync(updateInput.Code.ToByteArray(), chainContext.BlockHash,
