...
{
    public static async Task<BlockWithTransactions> GetBlockWithTransactionsByHashAsync(
        this IBlockchainService blockchainService, Hash blockHash)
    {
    ...
    public static async Task<List<BlockWithTransactions>> GetBlocksWithTransactionsAsync(
