...
public partial class PlainTransactionExecutingService
{
    protected async Task<FlowBehavior> HandleExceptionWhileGettingExecutive(SmartContractFindRegistrationException ex,
    ...
    protected async Task<FlowBehavior> HandleExceptionWhileApplyingExecutive(Exception ex, IExecutive executive,
