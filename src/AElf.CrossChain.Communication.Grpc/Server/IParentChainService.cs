...
{
//    public interface IParentChainService
//    {
//        Task<CrossChainResponse> GenerateResponseAsync(Block block, int remoteSideChainId);
//
//        Task<SideChainInitializationData> GetChainInitializationContextAsync(int chainId, LastIrreversibleBlockDto libDto);
//    }
//
//    internal class ParentChainService : IParentChainService, ITransientDependency
//    {
//        private readonly IBlockExtraDataService _blockExtraDataService;
//        private readonly ICrossChainDataProvider _crossChainDataProvider;
//
//        public ParentChainService(IBlockExtraDataService blockExtraDataService, ICrossChainDataProvider crossChainDataProvider)
//        {
...
//        }
//
//        public async Task<SideChainInitializationData> GetChainInitializationContextAsync(int chainId, LastIrreversibleBlockDto libDto)
//        {
//            var chainInitializationContext =
//                await _crossChainDataProvider.GetChainInitializationContextAsync(chainId, libDto.BlockHash,
//                    libDto.BlockHeight);
//            var sideChainInitializationResponse = new SideChainInitializationData
//            {
