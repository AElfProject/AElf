...
{
    public class BlockAcceptedLogEventListeningService : IBlockAcceptedLogEventListeningService, ISingletonDependency
    {
        ...
        private readonly List<IBlockAcceptedLogEventHandler> _eventHandlers;
        
        public ILogger<BlockAcceptedLogEventListeningService> Logger { get; set; }

        public BlockAcceptedLogEventListeningService(IBlockchainService blockchainService,
            ITransactionResultQueryService transactionResultQueryService,
            IServiceContainer<IBlockAcceptedLogEventHandler> eventHandlers)
        {
