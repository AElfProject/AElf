...
namespace AElf.Contracts.Resource.Tests
{
    public class ResourceContractTest : ContractTestBase<ResourceContractTestAElfModule>
    {
        ...
        private readonly ECKeyPair FeeKeyPair;
        private readonly ECKeyPair FoundationKeyPair;

        private readonly Address BasicZeroContractAddress;
        private readonly Address TokenContractAddress;
        private readonly Address ResourceContractAddress;
        private readonly Address FeeReceiverContractAddress;
        ...
        public async Task Lock_Available_Resource()
        {
            ...
            var lockedBalance = SInt64Value.Parser.ParseFrom(await Tester.CallContractMethodAsync(
                ResourceContractAddress,
            ...
            var controllerBalance = SInt64Value.Parser.ParseFrom(await Tester.CallContractMethodAsync(
                ResourceContractAddress,
                nameof(ResourceContract.GetUserBalance),
                new UserResourceId
                {
        ...
        public async Task Unlock_Available_Resource()
        {
            await Buy_Resource_WithEnough_Token(1000L);
            var ownerAddress = Tester.GetAddress(Tester.KeyPair);
            var userBalance0 = SInt64Value.Parser.ParseFrom(await Tester.CallContractMethodAsync(
                ResourceContractAddress,
                nameof(ResourceContract.GetUserBalance),
                new UserResourceId
                {
            ...
            //Verify
            var userBalance1 = SInt64Value.Parser.ParseFrom(await receiver.CallContractMethodAsync(
                ResourceContractAddress,
                nameof(ResourceContract.GetUserBalance),
                new UserResourceId
                {
            ...
            var controllerBalance = SInt64Value.Parser.ParseFrom(await receiver.CallContractMethodAsync(
                ResourceContractAddress,
                nameof(ResourceContract.GetUserBalance),
                new UserResourceId
                {
            ...
            var lockedBalance = SInt64Value.Parser.ParseFrom(await receiver.CallContractMethodAsync(
                ResourceContractAddress,
                nameof(ResourceContract.GetUserLockedBalance),
                new UserResourceId
                {
