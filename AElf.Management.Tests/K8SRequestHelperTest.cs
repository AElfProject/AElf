...
namespace AElf.Management.Tests
{
    public class K8SRequestHelperTest
    {
        ...
        public void NamespaceTest()
        {
            ...
            var space1 = K8SRequestHelper.ListNamespace();
            Assert.True(space1.Items.Select(n => n.Metadata.Name == name).Any());
                
            K8SRequestHelper.DeleteNamespace(new V1DeleteOptions(), name);
            var space2 = K8SRequestHelper.ListNamespace();
        ...
        public void ConfigMapTest()
        {
            ...
            body.Metadata.NamespaceProperty = space;
            body.Data = new Dictionary<string, string>();
            body.Data.Add("1", "1");
            body.Data.Add("2", "2");

            K8SRequestHelper.CreateNamespacedConfigMap(body, space);

            var configList1 = K8SRequestHelper.ListNamespacedConfigMap(space);
            Assert.True(configList1.Items.Select(n => n.Metadata.Name == name).Any());
            ...
            K8SRequestHelper.PatchNamespacedConfigMap(bodyPatch, name, space);

            var configList2 = K8SRequestHelper.ListNamespacedConfigMap(space);

            K8SRequestHelper.DeleteNamespacedConfigMap(new V1DeleteOptions(), name, space);
        }
        ...
        public void ServiceTest()
        {
            ...
            var sercices1 = K8SRequestHelper.ListNamespacedService("default");
