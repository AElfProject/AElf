 ...
 TODO: https://github.com/AElfProject/AElf/issues/338 */
    ...
    public class TrackedRouterTest : TestKitBase
    {
        ...
        public void ThreeJobsExecutionTest()
        {
            ...
            _mock.Router.Tell(new JobExecutionRequest(0, _mock.ChainId1, job, DateTime.UtcNow,TestActor, _mock.Router));
            _mock.Router.Tell(new JobExecutionRequest(1, _mock.ChainId1, job, DateTime.UtcNow,TestActor, _mock.Router));
            _mock.Router.Tell(new JobExecutionRequest(2, _mock.ChainId1, job, DateTime.UtcNow,TestActor, _mock.Router));
