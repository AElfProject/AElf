    ...
    public class FunctionMetadataServiceTest
    {
        ...
        {   
            ...
            Assert.Equal(new FunctionMetadata(
                ...
                })), await _dataStore.GetAsync<FunctionMetadata>(ResourcePath.CalculatePointerForMetadata(chainId, addrC.ToHex() + ".Func0")));
            ...
            Assert.Equal(new FunctionMetadata(
                ...
                })), await _dataStore.GetAsync<FunctionMetadata>(ResourcePath.CalculatePointerForMetadata(chainId, addrC.ToHex() + ".Func1")));
            ...
            Assert.Equal(new FunctionMetadata(
                ...
                })), await _dataStore.GetAsync<FunctionMetadata>(ResourcePath.CalculatePointerForMetadata(chainId, addrB.ToHex() + ".Func0")));
            ...
            Assert.Equal(new FunctionMetadata(
                ...
                })), await _dataStore.GetAsync<FunctionMetadata>(ResourcePath.CalculatePointerForMetadata(chainId, addrB.ToHex() + ".Func1")));

            await _functionMetadataService.DeployContract(chainId, addrA, contractATemplate);
            
            Assert.Equal(new FunctionMetadata(
                new HashSet<string>(),
                new HashSet<Resource>()), await _dataStore.GetAsync<FunctionMetadata>(ResourcePath.CalculatePointerForMetadata(chainId, addrA.ToHex() + ".Func0(int)")));
            ...
            Assert.Equal(new FunctionMetadata(
                ...
                })), await _dataStore.GetAsync<FunctionMetadata>(ResourcePath.CalculatePointerForMetadata(chainId, addrA.ToHex() + ".Func0")));
            ...
            Assert.Equal(new FunctionMetadata(
                ...
                new HashSet<Resource>(new[]
                {
                    new Resource(addrA.Value.ToByteArray().ToHex() + ".resource1", DataAccessMode.ReadOnlyAccountSharing),
                    new Resource(addrA.Value.ToByteArray().ToHex() + ".resource2", DataAccessMode.ReadWriteAccountSharing)
                })), await _dataStore.GetAsync<FunctionMetadata>(ResourcePath.CalculatePointerForMetadata(chainId, addrA.ToHex() + ".Func1")));
            ...
            Assert.Equal(new FunctionMetadata(
                ...
                new HashSet<Resource>(new[]
                {
                    new Resource(addrA.Value.ToByteArray().ToHex() + ".resource1", DataAccessMode.ReadOnlyAccountSharing),
                    new Resource(addrA.Value.ToByteArray().ToHex() + ".resource2", DataAccessMode.ReadWriteAccountSharing)
                })), (await _dataStore.GetAsync<FunctionMetadata>(ResourcePath.CalculatePointerForMetadata(chainId, addrA.ToHex() + ".Func2"))));
            ...
            Assert.Equal(new FunctionMetadata(
                ...
                new HashSet<Resource>(new[]
                {
                    ...
                    new Resource(addrA.Value.ToByteArray().ToHex() + ".resource1", DataAccessMode.ReadOnlyAccountSharing),
                    new Resource(addrA.Value.ToByteArray().ToHex() + ".resource2", DataAccessMode.ReadWriteAccountSharing)
                })), await _dataStore.GetAsync<FunctionMetadata>(ResourcePath.CalculatePointerForMetadata(chainId, addrA.ToHex() + ".Func3")));
            ...
            Assert.Equal(new FunctionMetadata(
                ...
                new HashSet<Resource>(new[]
                {
                    new Resource(addrA.Value.ToByteArray().ToHex() + ".resource1", DataAccessMode.ReadOnlyAccountSharing),
                    new Resource(addrA.Value.ToByteArray().ToHex() + ".resource2", DataAccessMode.ReadWriteAccountSharing)
                })), await _dataStore.GetAsync<FunctionMetadata>(ResourcePath.CalculatePointerForMetadata(chainId, addrA.ToHex() + ".Func4")));
            ...
            Assert.Equal(new FunctionMetadata(
                ...
                new HashSet<Resource>(new[]
                {
                    ...
                    new Resource(addrA.Value.ToByteArray().ToHex() + ".resource1", DataAccessMode.ReadOnlyAccountSharing),
                    new Resource(addrA.Value.ToByteArray().ToHex() + ".resource2", DataAccessMode.ReadWriteAccountSharing)
                })), await _dataStore.GetAsync<FunctionMetadata>(ResourcePath.CalculatePointerForMetadata(chainId, addrA.ToHex() + ".Func5")));
            ...
            Assert.Equal(callGraph, await _dataStore.GetAsync<SerializedCallGraph>(ResourcePath.CalculatePointerForMetadataTemplateCallingGraph(chainId)));
        }
        [Fact]
        public async Task TestEmptyContract()
        {
            ...
            Assert.Equal(new FunctionMetadata(
                ...
                })), (await _dataStore.GetAsync<FunctionMetadata>(ResourcePath.CalculatePointerForMetadata(chainId, contract1Addr.ToHex() + ".Func1"))));
            ...
            Assert.Equal(new FunctionMetadata(
                ...
                {
                    new Resource(contract1Addr.Value.ToByteArray().ToHex() + "._lock", DataAccessMode.ReadWriteAccountSharing)
                })), (await _dataStore.GetAsync<FunctionMetadata>(ResourcePath.CalculatePointerForMetadata(chainId, contract1Addr.ToHex() + ".Func2"))));
            ...
            Assert.Equal(new FunctionMetadata(
                ...
                })), (await _dataStore.GetAsync<FunctionMetadata>(ResourcePath.CalculatePointerForMetadata(chainId, contract2Addr.ToHex() + ".Func1"))));
            ...
            Assert.Equal(new FunctionMetadata(
                ...
                {
                    new Resource(contract2Addr.Value.ToByteArray().ToHex() + "._lock", DataAccessMode.ReadWriteAccountSharing)
                })), (await _dataStore.GetAsync<FunctionMetadata>(ResourcePath.CalculatePointerForMetadata(chainId, contract2Addr.ToHex() + ".Func2"))));
            ...
            Assert.Equal(new FunctionMetadata(
                ...
                {
                    new Resource(contract1Addr.Value.ToByteArray().ToHex() + "._lock", DataAccessMode.ReadWriteAccountSharing)
                })), (await _dataStore.GetAsync<FunctionMetadata>(ResourcePath.CalculatePointerForMetadata(chainId, refContractAddr.ToHex() + ".Func1"))));
            ...
            Assert.Equal(new FunctionMetadata(
                ...
                })), (await _dataStore.GetAsync<FunctionMetadata>(ResourcePath.CalculatePointerForMetadata(chainId, refContractAddr.ToHex() + ".Func1_1"))));
            Assert.Equal(new FunctionMetadata(
                new HashSet<string>(new []{contract1Addr.ToHex() + ".Func2"}),
                new HashSet<Resource>(new []
                {
                    new Resource(contract1Addr.Value.ToByteArray().ToHex() + "._lock", DataAccessMode.ReadWriteAccountSharing),
                })), (await _dataStore.GetAsync<FunctionMetadata>(ResourcePath.CalculatePointerForMetadata(chainId, refContractAddr.ToHex() + ".Func2"))));
            ...
            Assert.Equal(new FunctionMetadata(
                ...
                new HashSet<Resource>(new []
                {
                    new Resource(contract1Addr.Value.ToByteArray().ToHex() + "._lock", DataAccessMode.ReadWriteAccountSharing),
                    new Resource(refContractAddr.Value.ToByteArray().ToHex() + ".localRes", DataAccessMode.AccountSpecific)
                })), (await _dataStore.GetAsync<FunctionMetadata>(ResourcePath.CalculatePointerForMetadata(chainId, refContractAddr.ToHex() + ".Func2_1"))));
            ...
            Assert.Equal(new FunctionMetadata(
                ...
                {
                    new Resource(contract1Addr.Value.ToByteArray().ToHex() + "._lock", DataAccessMode.ReadWriteAccountSharing),
                })), (await _dataStore.GetAsync<FunctionMetadata>(ResourcePath.CalculatePointerForMetadata(chainId, refContractAddr.ToHex() + ".Func2_2"))));
            ...
            Assert.Equal(new FunctionMetadata(
                ...
                {
                    new Resource(contract1Addr.Value.ToByteArray().ToHex() + "._lock", DataAccessMode.ReadWriteAccountSharing),
                })), (await _dataStore.GetAsync<FunctionMetadata>(ResourcePath.CalculatePointerForMetadata(chainId, refContractAddr.ToHex() + ".Func3"))));
            ...
            Assert.Equal(new FunctionMetadata(
                ...
                new HashSet<Resource>(new []
                {
                    new Resource(contract1Addr.Value.ToByteArray().ToHex() + "._lock", DataAccessMode.ReadWriteAccountSharing),
                    new Resource(contract2Addr.Value.ToByteArray().ToHex() + "._lock", DataAccessMode.ReadWriteAccountSharing)
                })), (await _dataStore.GetAsync<FunctionMetadata>(ResourcePath.CalculatePointerForMetadata(chainId, refContractAddr.ToHex() + ".Func4"))));
            ...
            Assert.Equal(new FunctionMetadata(
                ...
                new HashSet<Resource>(new []
                {
                    new Resource(contract1Addr.Value.ToByteArray().ToHex() + "._lock", DataAccessMode.ReadWriteAccountSharing),
                    new Resource(addrC.Value.ToByteArray().ToHex() + ".resource4", DataAccessMode.AccountSpecific),
                })), (await _dataStore.GetAsync<FunctionMetadata>(ResourcePath.CalculatePointerForMetadata(chainId, refContractAddr.ToHex() + ".Func5"))));
