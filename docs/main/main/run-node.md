...
Note that a more detailed section about the cli can be found [command line interface](https://github.com/AElfProject/AElf/tree/d9b95cf4f15439f86c567bac571c01c34cdeb36c/docs/tutorials/cli/cli.md).
...
The _NodeAccount_ field corresponds to the address, you also have to enter the password that you entered earlier.
...
For reference and after you've started a node, you can get infos about an account with the _aelf-command console_ command:
