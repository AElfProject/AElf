...
Get current serial number of contract.
...
Get detail infomation of the input contract.
...
detail infomation of the input contract.
...
Get author of the input contract.
...
Get code hash of the input contract.
...
code hash of the input contract.
...
Get registration of the smart contract by it's address.
...
Validate address of the input contract.
...
Deploy system smart contract on chain.

**Parameters:**

***SystemContractDeploymentInput*** 

- ***category*** - new contract owner address
- ***code*** - byte array of the contract
- ***name*** - name hash of the contract
